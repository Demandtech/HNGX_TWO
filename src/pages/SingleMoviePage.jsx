    ...
    <main className='grid lg:grid-cols-[200px,1fr] min-h-screen singlepage'>
      ...
      <div className='p-5'>
        ...
        <div className='flex items-center flex-wrap'>
          <p className='text-[#404040] text-[1.2rem] mr-10'>
            <span>Top Gun: Maverick</span> • <span> 2022 </span> •
            <span> PG-13 </span> • <span>2h 10m</span>
          </p>
          <div className='flex gap-3 text-[#B91C1C]'>
            {['Drama', 'Action'].map((item, index) => (
              <span
                className='text-sm px-2 rounded-[15px] border border-[#F8E7EB]'
                key={index}
              >
                {item}
              </span>
        ...
        <div className='flex flex-col lg:flex-row mt-5'>
          <div className='lg:w-[70%] pb-5 lg:pb-0'>
            <p className='text-[#333] lg:text-[18px] mb-5'>
              ...
              leads TOP GUN&apos; s elite graduates on a mission that demands
